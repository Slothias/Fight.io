...
GameScreen::GameScreen(sf::RenderWindow *App, Client* my)
{
    ...
    for(int i=0; i<5; i++)
    {
        ...
        scoreboard[i].setFillColor(sf::Color(0,0,0,200));
...
else
{
    ...
    if(sf::Joystick::isConnected(0))
    {
        ...
        //Az�rt kell, hogy ne mehessen ki. A keypress eventn�l nem vizsg�lhatjuk, mert nincs mindig key press event.
            ...
            //ezekbe m�r nem l�p be, ha a p�ly�nak valamelyik sz�l�n van
